...
export default function App() {
  ...
  return (
    <div className="w-full max-w-md mx-auto h-screen bg-slate-950 text-slate-200 flex flex-col font-sans relative overflow-hidden select-none">
      ...
      {/* --- GOAL CRUSHED TOAST --- */}
      {goalToast && (
        <div className="absolute top-[45%] translate-y-2 -translate-x-1/2 z-[100] animate-in fade-in slide-in-from-top-4 duration-300 pointer-events-none">
          <div className="bg-slate-900 border border-pink-500 rounded-2xl py-12 px-12 shadow-[0_0_30px_rgba(236,72,153,0.35)] flex items-center">
