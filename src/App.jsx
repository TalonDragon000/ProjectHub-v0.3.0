...
export default function App() {
  ...
  return (
    <div className="w-full max-w-md mx-auto h-screen bg-slate-950 text-slate-200 flex flex-col font-sans relative overflow-hidden select-none">
        ...
        {activeTab === 'home' && (
          <div className="p-4 space-y-6 pb-24">
            ...
            <section className="space-y-2">
              <h3 className="text-violet-400 text-xs font-bold uppercase tracking-widest flex items-center"><Target className="w-4 h-4 mr-1"/> Strategy Specs</h3>
      ...
      {/* --- GOAL CRUSHED TOAST --- */}
      {goalToast && (
        <div className="absolute top-1/2 left-1/2 translate-y-4 -translate-x-1/2 z-[100] animate-in fade-in slide-in-from-top-4 duration-300 pointer-events-none">
          <div className="bg-slate-900 border border-pink-500 rounded-2xl px-6 py-3 shadow-[0_0_30px_rgba(236,72,153,0.35)] flex items-center space-x-3">
            <div className="text-lg font-black text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-cyan-400">Goal Crushed!</div>
            <div className="text-xs text-slate-400 font-bold">Momentum increased.</div>
          </div>
        </div>
      )}
