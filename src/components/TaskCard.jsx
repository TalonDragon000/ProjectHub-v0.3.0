...
export default function TaskCard({ task }) {
  ...
  return (
    <div className="relative group">
      ...
      {menuOpen && (
        <div className="absolute top-10 right-10 z-40 bg-surface border border-subtle rounded-xl shadow-2xl overflow-hidden min-w-[160px] animate-in fade-in-0 zoom-in-95 duration-100">
